...
docker exec -it $M_PID mysql -uroot -proot mysql -e " create table if not exists TWAL_DB.CANDI_TBL ( HASH VARCHAR(64) NULL, TITLE VARCHAR(128) NULL, ADD_TIME INT NULL, STATUS INT NULL, CATEGORY VARCHAR(16) NULL, SITENAME VARCHAR(64) NULL )"
...
docker exec -it $M_PID mysql -uroot -proot mysql -e "create table if not exists TWAL_DB.RUN_TBL ( HASH VARCHAR(64) NULL, TITLE VARCHAR(128) NULL, ADD_TIME INT NULL, STATUS INT NULL, CATEGORY VARCHAR(16) NULL, SITENAME VARCHAR(64) NULL )"
